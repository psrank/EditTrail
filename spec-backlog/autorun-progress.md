...
| 004       | global-project-search        | —             | pending |         |           |
...
- [x] branch  <!-- feat/intuitive-search -->
- [x] propose
- [x] review
- [x] tests-before
- [x] apply
...
- [x] branch  <!-- feat/file-type-filters -->
- [x] propose
- [x] review
- [x] tests-before
- [x] apply
